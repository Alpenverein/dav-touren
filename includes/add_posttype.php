...
function cpt_tours() {
    ...
    $args = array(
        ...
        'capabilities' => array(
            'edit_others_posts'     => 'Touren anderer Nutzer editieren',
            'delete_others_posts'   => 'Touren anderer Nutzer löschen',
            'delete_private_posts'  => 'Private Touren anderer Nutzer löschen',
            'edit_private_posts'    => 'Private Touren anderer Nutzer editieren',
            'read_private_posts'    => 'Private Touren anderer Nutzer lesen',
            'edit_published_posts'  => 'Veröffentlichte Touren anderer Nutzer editieren',
            'publish_posts'         => 'Touren veröffentlichen',
            'delete_published_posts'=> 'Veröffentlichte Touren anderer Nutzer löschen',
            'edit_posts'            => 'Touren bearbeiten'   ,
            'delete_posts'          => 'Touren löschen',
            'edit_post'             => 'Tour bearbeiten',
            'read_post'             => 'Tour lesen',
            'delete_post'           => 'Tour löschen',
        ),
        'map_meta_cap' => true,
    );
